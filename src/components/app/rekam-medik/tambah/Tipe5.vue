  ...
  <div>
    ...
    <v-stepper vertical v-model="step">
      ...
      <v-stepper-content step="2">
        <pemilik-edit-form :id-pemilik="pemilikId"
          @done="save" />
      </v-stepper-content>
...
import PemilikEditForm from './PemilikEditForm'
...
export default {
  ...
  methods: {
    async takePasienData (pasienId) {
      let { temp_pemilik_id } = await Services.Pasien.getById(pasienId)
      // eslint-disable-next-line
      this.pemilikId = temp_pemilik_id
